	...
	<div class="divBook">
		<ul>
			<c:forEach items="${pageBean.beanList}" var="book">
				<li>
					<div class="inner">
						<a class="pic" href="<c:url value='/admin/AdminBookServlet?method=loadBook&bid=${book.bid}'/>">
						...
						<p><a id="bookname" title="${book.bname}）" href="<c:url value='/admin/AdminBookServlet?method=loadBook&bid=${book.bid}'/>">${book.bname}</a></p>
