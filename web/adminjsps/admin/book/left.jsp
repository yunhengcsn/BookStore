...
function load() {
	...
	<c:forEach items="${categoryList}" var="category">
		<c:forEach items="${category.children}" var="child">
			bar.add("${category.cname}","${child.cname}","/BookStore_war_exploded/admin/AdminBookServlet?method=loadBooks&cid=${child.cid}", "body");
		</c:forEach>
	</c:forEach>

	/*bar.add("程序设计", "Java Javascript", "/BookStore_war_exploded/adminjsps/admin/book/list.jsp", "body");
