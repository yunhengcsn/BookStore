...
<style type="text/css">
  ...
  <body>
    ...
    <form action="<c:url value='/admin/AdminCategoryServlet'/>" method="post" onsubmit="return checkForm()">
    	<input type="hidden" name="method" value="editSecondLevel"/>
    	...
    	一级分类：<select name="pid" id="pid">
    		...
    		<option value="${category.parent.cid}" selected='selected'>${category.parent.cname}</option>
			<c:forEach items="parents" var="parent">
				<c:if test="${parent.pid != category.parent.cid}">
