  ...
  <div>
    ...
    <div class="divBookDesc">
	    <ul>
	    	...
	    	<li>原价：<span class="spanPrice">&yen;${book.price}</span>　折扣：<span style="color: #c30;">${book.discount}</span>折</li>
	    </ul>
		<hr class="hr1"/>
		<table>
			<tr>
		...
		<div class="divForm">
			<form id="form1" action="<c:url value='/CartServlet'/>" method="post">
				...
				<input type="hidden" name="bid" value="${book.bid}"/>
  				数量：<input id="cnt" style="width: 40px;text-align: center;" type="text" name="quantity" value="1"/>件
				<br/><br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="submit" style="background:orange; color: #FFFFFF; font-size: 30px; width:200px; height:60px" value="加入购物车"/>
  			</form>
