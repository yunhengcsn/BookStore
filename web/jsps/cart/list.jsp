	...
	<script type="text/javascript">
			...
			$(".jian").click(function() {
				...
				if(quantity == 1) {
					if(confirm("您是否真要删除该条目？")) {
						location = "/BookStore_war_exploded/CartItemServlet?method=batchDelete&cartItemIds=" + cartItemId;
					}
				} else {
		...
		function sendUpdate(cartItemId, quantity) {
			$.ajax({
				async:false,
				cache:false,
				url:"/BookStore_war_exploded/CartItemServlet",
		...
		function batchDelete() {
			...
			location = "/BookStore_war_exploded/CartItemServlet?method=batchDelete&cartItemIds=" + cartItemIdArray;
		}
