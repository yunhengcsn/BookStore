	...
	<c:forEach items="${cartItemList}" var="cartItem">
		<tr align="center">
			...
			<td align="left" width="70px">
				<a class="linkImage" href="<c:url value='/jsps/book/desc.jsp'/>"><img border="0" width="54" align="top" src="${cartItem.book.image_b}"/></a>
			</td>
			...
			<td>
				<a class="jian" id="12345Jian"></a>
				<input class="quantity" readonly="readonly" id="12345Quantity" type="text" value="${cartItem.quantity}"/>
				<a class="jia" id="12345Jia"></a>
			</td>
			<td width="100px">
